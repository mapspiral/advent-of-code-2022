public sealed class Puzzle11Tests : TestBase<Puzzle11>
{
    [Fact]
    ...
    public void HaveCorrectSolution2_Input()
    {
        ...
        solution.Should().Be(19457438264);
    }
}